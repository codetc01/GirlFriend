...
class DemoRealtime(IO):
    ...
    def start(self):
        ...
        self.arg.video = 'camera_source'
        self.arg.openpose = 'D:/openpose-master'
        if self.arg.openpose is not None:
            ...
            # sys.path.append('{}/build/python'.format(self.arg.openpose))
            #  下面的话是添加的
            os.environ['PATH'] = os.environ['PATH'] + ';' + 'D:/openpose-master/build/x64/Release/;' + 'D:/openpose-master/build/bin;'
        try:
        ...
        label_name_path = 'D:/st-gcn-master/resource/kinetics_skeleton/label_name.txt'
    ...
    def get_parser(add_help=False):
        ...
        parser.set_defaults(
            config='D:/st-gcn-master/config/st_gcn/kinetics-skeleton/demo_realtime.yaml')
